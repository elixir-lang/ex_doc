(() => {
  ...
  var Ps = (t, e, n, r) => {
    if (e && typeof e == "object" || typeof e == "function")
      for (let i of Ls(e))
        !_s.call(t, i) && i !== n && Un(t, i, { get: () => e[i], enumerable: !(r = ks(e, i)) || r.enumerable });
    return t;
  };
  var Y = (t, e, n) => (n = t != null ? Ss(Ts(t)) : {}, Ps(
    // If the importer is in node compatibility mode or this is not an ESM
    // file that has been converted to a CommonJS file using a Babel-
    // compatible transform (i.e. "__esModule" has not been set), then set
    // "default" to the CommonJS "module.exports" for node compatibility.
    e || !t || !t.__esModule ? Un(n, "default", { value: t, enumerable: !0 }) : n,
    t
  ));
  ...
  var fr = L((dc, hr) => {
    ...
    function Gs(t, e, n) {
      ...
      e = cr(e) || 0, Ve(n) && (c = !!n.leading, d = "maxWait" in n, s = d ? Ws(cr(n.maxWait) || 0, e) : s, h = "trailing" in n ? !!n.trailing : h);
      function p(k) {
        var I = r, $ = i;
        return r = i = void 0, u = k, o = t.apply($, I), o;
      }
      function g(k) {
        return u = k, a = setTimeout(w, e), c ? p(k) : o;
      }
      function m(k) {
        var I = k - l, $ = k - u, ee = e - I;
        return d ? zs(ee, s - $) : ee;
      }
      function v(k) {
        var I = k - l, $ = k - u;
        return l === void 0 || I >= e || I < 0 || d && $ >= s;
      }
      function w() {
        var k = Ht();
        if (v(k))
    ...
    function Ks(t, e, n) {
      ...
      if (typeof t != "function")
        throw new TypeError(dr);
      return Ve(n) && (r = "leading" in n ? !!n.leading : r, i = "trailing" in n ? !!n.trailing : i), Gs(t, e, {
        leading: r,
        maxWait: e,
        trailing: i
      });
    ...
    function Js(t) {
      return typeof t == "symbol" || Ys(t) && js.call(t) == Hs;
    }
    function cr(t) {
      if (typeof t == "number")
        return t;
      ...
      t = t.replace(Ns, "");
      var n = Bs.test(t);
      return n || Qs.test(t) ? qs(t.slice(2), n ? 2 : 8) : Ds.test(t) ? ur : +t;
    }
    hr.exports = Ks;
  });
  ...
  var q = L((N) => {
    ...
    Ut(/x/) && (N.isFunction = Ut = function(t) {
      return typeof t == "function" && jt.call(t) === "[object Function]";
    });
    N.isFunction = Ut;
    var _r = Array.isArray || function(t) {
      return t && typeof t == "object" ? jt.call(t) === "[object Array]" : !1;
    };
    N.isArray = _r;
    function co(t, e) {
    ...
    function ho(t) {
      ...
      return lo.test(t) ? t.replace(ao, uo) : t;
    }
    function fo(t) {
      return !t && t !== 0 ? !0 : !!(_r(t) && t.length === 0);
    }
    function po(t) {
      var e = Tr({}, t);
  ...
  var X = L((We, Pr) => {
    ...
    function zt(t, e) {
      var n = e && e.loc, r = void 0, i = void 0, s = void 0, o = void 0;
      n && (r = n.start.line, i = n.end.line, s = n.start.column, o = n.end.column, t += " - " + r + ":" + s);
      for (var a = Error.prototype.constructor.call(this, t), l = 0; l < Wt.length; l++)
        this[Wt[l]] = a[Wt[l]];
  ...
  var Cr = L((Ge, Ir) => {
    ...
    Ge.default = function(t) {
      t.registerHelper("each", function(e, n) {
        ...
        n.data && n.ids && (l = be.appendContextPath(n.data.contextPath, n.ids[0]) + "."), be.isFunction(e) && (e = e.call(this)), n.data && (a = be.createFrame(n.data));
        function u(g, m, v) {
          a && (a.key = g, a.index = m, a.first = m === 0, a.last = !!v, l && (a.contextPath = l + g)), o = o + r(e[g], {
            data: a,
            blockParams: be.blockParams([e[g], g], [l + g, null])
          });
        }
        if (e && typeof e == "object")
          if (be.isArray(e))
            for (var c = e.length; s < c; s++)
              s in e && u(s, s, s === e.length - 1);
          else if (global.Symbol && e[global.Symbol.iterator]) {
            for (var d = [], h = e[global.Symbol.iterator](), p = h.next(); !p.done; p = h.next())
              d.push(p.value);
            e = d;
            for (var c = e.length; s < c; s++)
              u(s, s, s === e.length - 1);
  ...
  var Br = L((Ye, Dr) => {
    ...
    Ye.default = function(t) {
      t.registerHelper("if", function(e, n) {
        if (arguments.length != 2)
          throw new Nr.default("#if requires exactly one argument");
        return Hr.isFunction(e) && (e = e.call(this)), !n.hash.includeZero && !e || Hr.isEmpty(e) ? n.inverse(this) : n.fn(this);
  ...
  var qr = L((Je, Qr) => {
    "use strict";
    Je.__esModule = !0;
    Je.default = function(t) {
      t.registerHelper("log", function() {
        for (var e = [void 0], n = arguments[arguments.length - 1], r = 0; r < arguments.length - 1; r++)
          e.push(arguments[r]);
        var i = 1;
        n.hash.level != null ? i = n.hash.level : n.data && n.data.level != null && (i = n.data.level), e[0] = i, t.log.apply(t, e);
      });
    };
  ...
  var Vr = L((Xe, Fr) => {
    ...
    Xe.default = function(t) {
      t.registerHelper("lookup", function(e, n, r) {
        return e && r.lookupProperty(e, n);
      });
    };
  ...
  var Ur = L((Ze, $r) => {
    ...
    Ze.default = function(t) {
      t.registerHelper("with", function(e, n) {
        ...
        Ee.isFunction(e) && (e = e.call(this));
        var r = n.fn;
        if (Ee.isEmpty(e))
          return n.inverse(this);
        var i = n.data;
        return n.data && n.ids && (i = Ee.createFrame(n.data), i.contextPath = Ee.appendContextPath(n.data.contextPath, n.ids[0])), r(e, {
          data: i,
          blockParams: Ee.blockParams([e], [i && i.contextPath])
        });
      });
    };
  ...
  var Kt = L((et) => {
    ...
    function Vo(t) {
      Oo.default(t), Io.default(t), Ro.default(t), Ho.default(t), Do.default(t), Qo.default(t), Fo.default(t);
    }
    function $o(t, e, n) {
  ...
  var Wr = L((tt, jr) => {
    ...
    tt.__esModule = !0;
    var Uo = q();
    tt.default = function(t) {
      t.registerDecorator("inline", function(e, n, r, i) {
        var s = e;
  ...
  var Jt = L((nt, Gr) => {
    ...
    var Ko = q(), fe = {
      ...
      lookupLevel: function(e) {
        if (typeof e == "string") {
          var n = Ko.indexOf(fe.methodMap, e.toLowerCase());
          n >= 0 ? e = n : e = parseInt(e, 10);
        }
        return e;
      },
      // Can be overridden in the host environment
      log: function(e) {
        if (e = fe.lookupLevel(e), typeof console < "u" && fe.lookupLevel(fe.level) <= e) {
          var n = fe.methodMap[e];
          console[n] || (n = "log");
  ...
  var Kr = L((Xt) => {
    ...
    function Jo() {
      for (var t = arguments.length, e = Array(t), n = 0; n < t; n++)
        e[n] = arguments[n];
      return Yo.extend.apply(void 0, [/* @__PURE__ */ Object.create(null)].concat(e));
    }
  });
  ...
  var Zt = L((xe) => {
    ...
    function ta(t) {
      ...
      return n.__proto__ = !1, {
        properties: {
          whitelist: Yr.createNewLookupObject(n, t.allowedProtoProperties),
          defaultValue: t.allowProtoPropertiesByDefault
        },
        methods: {
          whitelist: Yr.createNewLookupObject(e, t.allowedProtoMethods),
          defaultValue: t.allowProtoMethodsByDefault
        }
      };
    }
    function na(t, e, n) {
      return Jr(typeof t == "function" ? e.methods : e.properties, n);
    }
    function Jr(t, e) {
      return t.whitelist[e] !== void 0 ? t.whitelist[e] === !0 : t.defaultValue !== void 0 ? t.defaultValue : (ra(e), !1);
    }
    function ra(t) {
...
See https://handlebarsjs.com/api-reference/runtime-options.html#options-to-control-prototype-access for details`));
  ...
  var rn = L((U) => {
    ...
    function nn(t, e, n) {
      this.helpers = t || {}, this.partials = e || {}, this.decorators = n || {}, oa.registerDefaultHelpers(this), aa.registerDefaultDecorators(this);
    }
    nn.prototype = {
      constructor: nn,
      logger: it.default,
      log: it.default.log,
      registerHelper: function(e, n) {
        if (oe.toString.call(e) === tn) {
          if (n)
      ...
      registerPartial: function(e, n) {
        if (oe.toString.call(e) === tn)
          oe.extend(this.partials, e);
        else {
          if (typeof n > "u")
            throw new en.default('Attempting to register a partial called "' + e + '" as undefined');
          this.partials[e] = n;
        }
      },
  ...
  var oi = L((Z) => {
    ...
    function Ea(t) {
      var e = t && t[0] || 1, n = K.COMPILER_REVISION;
      if (!(e >= K.LAST_COMPATIBLE_COMPILER_REVISION && e <= K.COMPILER_REVISION))
        if (e < K.LAST_COMPATIBLE_COMPILER_REVISION) {
          var r = K.REVISION_CHANGES[n], i = K.REVISION_CHANGES[e];
    ...
    function xa(t, e) {
      ...
      var n = t.compiler && t.compiler[0] === 7;
      function r(o, a, l) {
        l.hash && (a = z.extend({}, a, l.hash), l.ids && (l.ids[0] = !0)), o = e.VM.resolvePartial.call(this, o, a, l);
        var u = z.extend({}, l, {
          hooks: this.hooks,
          protoAccessControl: this.protoAccessControl
        }), c = e.VM.invokePartial.call(this, o, a, u);
        if (c == null && e.compile && (l.partials[l.name] = e.compile(o, t.compilerOptions, e), c = l.partials[l.name](a, u)), c != null) {
          if (l.indent) {
            for (var d = c.split(`
...
`);
      ...
      function s(o) {
        ...
        s._setup(a), !a.partial && t.useData && (l = La(o, l));
        var u = void 0, c = t.useBlockParams ? [] : void 0;
        t.useDepths && (a.depths ? u = o != a.depths[0] ? [o].concat(a.depths) : a.depths : u = [o]);
        function d(h) {
          return "" + t.main(i, h, i.helpers, i.partials, l, c, u);
        }
        return d = si(t.main, d, i, a.depths || [], l, c), d(o, a);
      }
      return s.isTop = !0, s._setup = function(o) {
        if (o.partial)
          ...
          Ta(a, i), i.helpers = a, t.usePartial && (i.partials = i.mergeIfNeeded(o.partials, e.partials)), (t.usePartial || t.useDecorators) && (i.decorators = z.extend({}, e.decorators, o.decorators)), i.hooks = {}, i.protoAccessControl = ri.createProtoAccessControl(o);
        ...
        return ot(i, o, t[o], a, 0, l, u);
      }, s;
    }
    function ot(t, e, n, r, i, s, o) {
      function a(l) {
        var u = arguments.length <= 1 || arguments[1] === void 0 ? {} : arguments[1], c = o;
        return o && l != o[0] && !(l === t.nullContext && o[0] === null) && (c = [l].concat(o)), n(t, l, t.helpers, t.partials, u.data || r, s && [u.blockParams].concat(s), c);
      }
      return a = si(n, a, t, o, r, s), a.program = e, a.depth = o ? o.length : 0, a.blockParams = i || 0, a;
    }
    function Sa(t, e, n) {
      return t ? !t.call && !n.name && (n.name = t, t = n.partials[t]) : n.name === "@partial-block" ? t = n.data["partial-block"] : t = n.partials[n.name], t;
    }
    function ka(t, e, n) {
    ...
    function La(t, e) {
      return (!e || !("root" in e)) && (e = e ? K.createFrame(e) : {}, e.root = t), e;
    }
    function si(t, e, n, r, i, s) {
      if (t.decorator) {
        var o = {};
        e = t.decorator(e, o, n, r && r[0], i, s, r), z.extend(e, o);
      }
      return e;
    }
    function Ta(t, e) {
    ...
    function _a(t, e) {
      ...
      return ba.wrapHelper(t, function(r) {
  ...
  var li = L((at, ai) => {
    "use strict";
    at.__esModule = !0;
    at.default = function(t) {
      var e = typeof global < "u" ? global : window, n = e.Handlebars;
  ...
  var ae = L((lt, hi) => {
    ...
    function di() {
      var t = new ui.HandlebarsEnvironment();
      return an.extend(t, ui), t.SafeString = Aa.default, t.Exception = Ca.default, t.Utils = an, t.escapeExpression = an.escapeExpression, t.VM = ci, t.template = function(e) {
        return ci.template(e, t);
      }, t;
    }
    var Se = di();
    Se.create = di;
  ...
  var Vi = L((qi, Fi) => {
    (function() {
      ...
      t.utils = {}, t.utils.warn = function(e) {
        ...
        if (e == null)
          return e;
        for (var n = /* @__PURE__ */ Object.create(null), r = Object.keys(e), i = 0; i < r.length; i++) {
          var s = r[i], o = e[s];
          if (Array.isArray(o)) {
            n[s] = o.slice();
            continue;
      ...
      t.Set = function(e) {
        if (this.elements = /* @__PURE__ */ Object.create(null), e) {
      ...
      t.Pipeline = function() {
        this._stack = [];
      }, t.Pipeline.registeredFunctions = /* @__PURE__ */ Object.create(null), t.Pipeline.registerFunction = function(e, n) {
...
`, e);
      ...
      t.Vector = function(e) {
        ...
        for (var n = 0, r = this.elements, i = e.elements, s = r.length, o = i.length, a = 0, l = 0, u = 0, c = 0; u < s && c < o; )
      ...
      t.stemmer = function() {
        var e = {
          ...
          if (b = $, b.test(y)) {
            var _ = b.exec(y);
            S = _[1], ne = _[2], b = d, b.test(S) && (y = S + e[ne]);
          }
          if (b = ee, b.test(y)) {
            var _ = b.exec(y);
        ...
        for (var r = new t.TokenSet(), i = [{
          ...
          if (s.editsRemaining != 0) {
            ...
            if (s.str.length > 1) {
              ...
              d in s.node.edges ? h = s.node.edges[d] : (h = new t.TokenSet(), s.node.edges[d] = h), s.str.length == 1 && (h.final = !0), i.push({
                node: h,
                editsRemaining: s.editsRemaining - 1,
                str: c + s.str.slice(2)
              });
          ...
          for (var s = Object.keys(r.qNode.edges), o = s.length, a = Object.keys(r.node.edges), l = a.length, u = 0; u < o; u++)
            for (var c = s[u], d = 0; d < l; d++) {
              ...
              if (h == c || c == "*") {
                ...
                h in r.output.edges ? (v = r.output.edges[h], v.final = v.final || m) : (v = new t.TokenSet(), v.final = m, r.output.edges[h] = v), i.push({
                  qNode: g,
                  output: v,
                  node: p
                });
      ...
      t.Index = function(e) {
        ...
        for (var n = new t.Query(this.fields), r = /* @__PURE__ */ Object.create(null), i = /* @__PURE__ */ Object.create(null), s = /* @__PURE__ */ Object.create(null), o = /* @__PURE__ */ Object.create(null), a = /* @__PURE__ */ Object.create(null), l = 0; l < this.fields.length; l++)
          i[this.fields[l]] = new t.Vector();
        e.call(n, n);
        for (var l = 0; l < n.clauses.length; l++) {
          var u = n.clauses[l], c = null, d = t.Set.empty;
          ...
          for (var h = 0; h < c.length; h++) {
            var p = c[h];
            u.term = p;
            var g = t.TokenSet.fromClause(u), m = this.tokenSet.intersect(g).toArray();
            if (m.length === 0 && u.presence === t.Query.presence.REQUIRED) {
            ...
            for (var x = 0; x < m.length; x++)
              for (var P = m[x], Q = this.invertedIndex[P], V = Q._index, v = 0; v < u.fields.length; v++) {
                var w = u.fields[v], k = Q[w], I = Object.keys(k), $ = P + "/" + w, ee = new t.Set(I);
                if (u.presence == t.Query.presence.REQUIRED && (d = d.union(ee), o[w] === void 0 && (o[w] = t.Set.complete)), u.presence == t.Query.presence.PROHIBITED) {
                  a[w] === void 0 && (a[w] = t.Set.empty), a[w] = a[w].union(ee);
                  continue;
                }
                if (i[w].upsert(V, u.boost, function(Es, xs) {
                  ...
                  for (var ye = 0; ye < I.length; ye++) {
                    var Ie = I[ye], te = new t.FieldRef(Ie, w), Ce = k[Ie], Re;
                    (Re = r[te]) === void 0 ? r[te] = new t.MatchData(P, w, Ce) : Re.add(P, w, Ce);
                  }
                  s[$] = !0;
                }
              }
        ...
        for (var we = t.Set.complete, ce = t.Set.empty, l = 0; l < this.fields.length; l++) {
          var w = this.fields[l];
        ...
        if (n.isNegated()) {
          ...
          for (var l = 0; l < y.length; l++) {
            var te = y[l], B = t.FieldRef.fromString(te);
            r[te] = new t.MatchData();
          }
        }
        for (var l = 0; l < y.length; l++) {
          var B = t.FieldRef.fromString(y[l]), b = B.docRef;
        ...
        var n = {}, r = {}, i = e.fieldVectors, s = /* @__PURE__ */ Object.create(null), o = e.invertedIndex, a = new t.TokenSet.Builder(), l = t.Pipeline.load(e.pipeline);
      ...
      t.Builder = function() {
        this._ref = "id", this._fields = /* @__PURE__ */ Object.create(null), this._documents = /* @__PURE__ */ Object.create(null), this.invertedIndex = /* @__PURE__ */ Object.create(null), this.fieldTermFrequencies = {}, this.fieldLengths = {}, this.tokenizer = t.tokenizer, this.pipeline = new t.Pipeline(), this.searchPipeline = new t.Pipeline(), this.documentCount = 0, this._b = 0.75, this._k1 = 1.2, this.termIndex = 0, this.metadataWhitelist = [];
        ...
        for (var s = 0; s < i.length; s++) {
          var o = i[s], a = this._fields[o].extractor, l = a ? a(e) : e[o], u = this.tokenizer(l, {
            fields: [o]
          }), c = this.pipeline.run(u), d = new t.FieldRef(r, o), h = /* @__PURE__ */ Object.create(null);
        ...
        for (var e = {}, n = Object.keys(this.fieldTermFrequencies), r = n.length, i = /* @__PURE__ */ Object.create(null), s = 0; s < r; s++) {
          for (var o = t.FieldRef.fromString(n[s]), a = o.fieldName, l = this.fieldLengths[o], u = new t.Vector(), c = this.fieldTermFrequencies[o], d = Object.keys(c), h = d.length, p = this._fields[a].boost || 1, g = this._documents[o.docRef].boost || 1, m = 0; m < h; m++) {
            var v = d[m], w = c[v], x = this.invertedIndex[v]._index, P, Q, V;
            i[v] === void 0 ? (P = t.idf(this.invertedIndex[v], this.documentCount), i[v] = P) : P = i[v], Q = P * ((this._k1 + 1) * w) / (this._k1 * (1 - this._b + this._b * (l / this.averageFieldLength[a])) + w), Q *= p, Q *= g, V = Math.round(Q * 1e3) / 1e3, u.insert(x, V);
          }
          e[o] = u;
        }
        this.fieldVectors = e;
        ...
        this.metadata = /* @__PURE__ */ Object.create(null), e !== void 0 && (this.metadata[e] = /* @__PURE__ */ Object.create(null), this.metadata[e][n] = i);
        ...
        for (var n = Object.keys(e.metadata), r = 0; r < n.length; r++) {
          ...
          for (var o = 0; o < s.length; o++) {
            ...
            for (var u = 0; u < l.length; u++) {
              var c = l[u];
              this.metadata[i][a][c] == null ? this.metadata[i][a][c] = e.metadata[i][a][c] : this.metadata[i][a][c] = this.metadata[i][a][c].concat(e.metadata[i][a][c]);
            }
          }
        }
      }, t.MatchData.prototype.add = function(e, n, r) {
        if (!(e in this.metadata)) {
          this.metadata[e] = /* @__PURE__ */ Object.create(null), this.metadata[e][n] = r;
          return;
        }
        ...
        typeof define == "function" && define.amd ? define(n) : typeof qi == "object" ? Fi.exports = n() : e.lunr = n();
      }(this, function() {
        return t;
      });
    })();
  ...
  function jn(t) {
    if (zn(t))
      return !0;
    let e = /#.*\//;
    return t.includes("#") && !e.test(t) ? !1 : t.includes(".html");
  }
  function Wn(t) {
    let e = zn(t);
    return e ? Promise.resolve(e) : As(t);
  }
  function zn(t) {
    let e = Os.find((n) => t.includes(n.href));
    return e ? e.hint : null;
  }
  function As(t) {
    let e = t.replace(".html", ".html?hint=true");
    return new Promise((n, r) => {
      let i = document.createElement("iframe");
      i.setAttribute("src", e), i.style.display = "none";
      function s(a) {
  ...
  function Kn(t) {
    let n = t.querySelector("h1").textContent, r = t.querySelector(".docstring > p"), i = r ? r.innerHTML : "";
    return {
      kind: ie.function,
      title: n.trim(),
      description: i.trim()
  ...
  function Yn(t) {
    let n = t.querySelector("h1 > span").textContent, r = t.querySelector("#moduledoc p"), i = r ? r.innerHTML : "";
    return {
      kind: ie.module,
      title: n.trim(),
      description: i.trim()
  ...
  // js/helpers.js
  var f = document.querySelector.bind(document), C = document.querySelectorAll.bind(document);
  function Jn(t) {
  ...
  function Xn(t = !1) {
    ...
    if (!e)
      return t ? document.getElementById("top-content") : null;
  ...
  function Is(t) {
    ...
    for (; e; ) {
      if (He.includes(e.tagName))
        return Tt(e);
      e = e.previousElementSibling;
    }
    let n = t.parentNode;
    for (; n; ) {
      for (e = n.previousElementSibling; e; ) {
        if (He.includes(e.tagName))
          return Tt(e);
        e = e.previousElementSibling;
      }
  ...
  function Tt(t) {
    let e = document.createElement("div"), n = [t], r = t;
    for (; (r = r.nextSibling) && !(He.includes(r.tagName) && r.tagName <= t.tagName); )
      n.push(r);
    return e.append(...n), e;
  }
  function Zn(t) {
  ...
  function _t(t) {
    return fetch(t).then((e) => e.ok).catch(() => !1);
  }
  function he(t) {
    return !t || t.trim() === "";
  }
  ...
  function E(t, e, n) {
    ...
    for (let i in e)
      e[i] != null && r.setAttribute(i, e[i]);
    return n && r.replaceChildren(...n), r;
  }

  // js/globals.js
  var Cs = new URLSearchParams(window.location.search), Rs = window.self !== window.parent, Pt = Rs && Cs.has("hint"), R = Pt;
  function qe() {
  ...
  if (Pt && R) {
    let t = Xn(), e = t ? Kn(t) : ["modules", "tasks"].includes(De()) ? Yn(f(".content-inner")) : null;
    if (e) {
      let n = {
        hint: {
          ...e,
  ...
  var Ms = {
    ...
    update(e) {
      ...
      this._settings = { ...this._settings, ...e }, this._subscribers.forEach(
     ...
     */
    getAndSubscribe(e) {
      this._subscribers.push(e), e(this._settings);
    }
    _loadSettings() {
      try {
  ...
  function ir(t) {
    ...
    })), J && (clearTimeout(Fe), J.innerText = t, J.classList.add("show"), Fe = setTimeout(() => {
  ...
  M.getAndSubscribe(or);
  sr.addEventListener("change", or);
  function or() {
    let t = lr(), e = t === It || t !== Ct && sr.matches;
    document.body.classList.toggle(nr, e);
  }
  function ar() {
    let t = Mt[Mt.indexOf(lr()) + 1] || Mt[0];
    M.update({ theme: t }), ir(`Set theme to "${t}"`);
  }
  function lr() {
    return new URLSearchParams(window.location.search).get("theme") || M.get().theme || At;
  }
  ...
  function vr() {
    if (gr)
      return;
    gr = !0;
    let t = document.getElementById("sidebar-list-nav");
    if (!t)
      return;
    let e = De(), n = {
      extras: t.dataset.extras || "Pages",
      modules: "Modules",
    ...
    Object.entries(n).forEach(([r, i]) => {
      ...
      if (!s?.length)
        return;
      let o = `${r}-list-tab-button`, a = `${r}-tab-panel`, l = r === e, u = E("button", {
        id: o,
        role: "tab",
        tabindex: l ? 0 : -1,
      ...
      u.innerHTML = i, u.addEventListener("keydown", eo), u.addEventListener("click", to), t.appendChild(E("li", {}, [u]));
  ...
  function Qt(t, e) {
    return e.length ? [
      E("button", { "aria-label": "expand", "aria-expanded": !1, "aria-controls": t }),
      E("ul", { id: t }, e)
    ] : [];
  }
  function Xs(t) {
    return t.headers.map(
      ({ id: e, anchor: n }) => E("li", {}, [
        E("a", { href: `${t.id}.html#${n}` }, [e])
      ])
    );
  }
  function Zs(t) {
    let e = [];
    return t.sections?.length && e.push(E("li", {}, [
      E("a", { href: `${t.id}.html#content` }, ["Sections"]),
      ...Qt(
        `${t.id}-sections-list`,
        t.sections.map(
          ({ id: n, anchor: r }) => E("li", {}, [
            E("a", { href: `${t.id}.html#${r}` }, [n])
          ])
        )
      )
    ])), t.nodeGroups && (e.push(E("li", {}, [
      E("a", { href: `${t.id}.html#summary` }, ["Summary"])
    ])), e.push(...t.nodeGroups.map(
      ({ key: n, name: r, nodes: i }) => E("li", {}, [
        E("a", { href: `${t.id}.html#${n}` }, [r]),
        ...Qt(
          `node-${t.id}-group-${n}-list`,
          i.map(
            ({ anchor: s, title: o, id: a }) => E("li", {}, [
              E("a", { href: `${t.id}.html#${s}`, title: o, translate: "no" }, [a])
            ])
          )
        )
      ])
  ...
  function qt(t) {
    let e = document.getElementById("sidebar-list-nav").querySelector("[aria-selected]");
    e !== t && (e && (e.removeAttribute("aria-selected"), e.setAttribute("tabindex", "-1"), document.getElementById(e.getAttribute("aria-controls")).setAttribute("hidden", "hidden")), t.setAttribute("aria-selected", "true"), t.setAttribute("tabindex", "0"), document.getElementById(t.getAttribute("aria-controls")).removeAttribute("hidden"));
  }
  function yr() {
    f("#sidebar [role=tabpanel]:not([hidden]) a[aria-selected]")?.scrollIntoView();
  }
  function Bt() {
    let t = document.getElementById("sidebar"), { pathname: e, hash: n } = window.location, r = e.split("/").pop().replace(/\.html$/, "") + ".html", i = t.querySelector(`li a[href="${r + n}"]`) || t.querySelector(`li a[href="${r}"]`);
    if (!i)
      return;
    t.querySelectorAll(".full-list a[aria-selected]").forEach((o) => {
      o.removeAttribute("aria-selected");
    }), t.querySelectorAll(".full-list button[aria-expanded=true]").forEach((o) => {
  ...
  function eo(t) {
    if (!["ArrowRight", "ArrowLeft"].includes(t.key))
      return;
    let e = Array.from(C('#sidebar-list-nav [role="tab"]')), r = e.indexOf(t.currentTarget) + (t.key === "ArrowRight" ? 1 : -1), i = e.at(r % e.length);
    qt(i), i.focus();
  }
  function to(t) {
    qt(t.currentTarget), yr();
  }
  function no(t) {
    let e = t.target;
    e.tagName === "BUTTON" && e.setAttribute("aria-expanded", e.getAttribute("aria-expanded") === "false");
  }
  ...
  if (!R) {
    ...
    let t = document.getElementById("sidebar"), e = f(xr);
    e.addEventListener("click", je), document.body.addEventListener("click", (i) => {
      Ft.matches && Vt() && !t.contains(i.target) && !e.contains(i.target) && je();
    });
    ...
    t.addEventListener("mousedown", () => r.observe(t)), t.addEventListener("mouseup", () => r.unobserve(t)), window.addEventListener("hashchange", so);
  }
  function wr() {
    let e = sessionStorage.getItem(Nt) !== Dt && !Ft.matches;
    kr(e);
  }
  function je() {
    let t = !Vt();
    return sessionStorage.setItem(Nt, t ? pr : Dt), $t(t);
  }
  function Vt() {
  ...
  function kr(t) {
    t && vr(), document.body.classList.toggle($e, t), f(xr).setAttribute("aria-expanded", t ? "true" : "false");
  }
  var br;
  function $t(t) {
    return new Promise((e) => {
      document.body.classList.add(Ue), document.body.scrollTop, kr(t), clearTimeout(br), br = setTimeout(() => {
  ...
  var cn = Y(ae());
  cn.registerHelper("isArray", function(t, e) {
    return Array.isArray(t) ? e.fn(this) : e.inverse(this);
  });
  cn.registerHelper("isNonEmptyArray", function(t, e) {
    return Array.isArray(t) && t.length > 0 ? e.fn(this) : e.inverse(this);
  });

  // js/handlebars/templates/versions-dropdown.handlebars
  var pi = fi.template({ 1: function(t, e, n, r, i) {
    var s, o, a = e ?? (t.nullContext || {}), l = t.hooks.helperMissing, u = "function", c = t.escapeExpression, d = t.lookupProperty || function(h, p) {
...
`;
    ...
    var s, o = t.lookupProperty || function(a, l) {
...
`;
  }, compiler: [8, ">= 4.3.0"], main: function(t, e, n, r, i) {
    var s, o = e ?? (t.nullContext || {}), a = t.lookupProperty || function(l, u) {
...
`;
  ...
  if (!R) {
    let t = tr(), e = f(Da);
    if (t.length > 0 || !e) {
      let n = e.textContent.trim(), i = (t.some((u) => u.version === n) ? t : [{ version: n, url: "#" }, ...t]).map((u) => ({
        ...u,
        isCurrentVersion: u.version === n
      })), s = t.find((u) => u.latest), o = s?.version !== n ? s?.url : null;
      n.includes("-") && t.findIndex((u) => u.version === n) < t.findIndex((u) => u.latest) && (o = null), e.innerHTML = pi({ nodes: i, latestVersion: o });
      let a = f(mi);
  ...
  function Qa(t) {
    ...
    e.style.visibility = "hidden", e.style.position = "absolute", e.style.whiteSpace = "nowrap", e.style.font = window.getComputedStyle(t).font, e.textContent = t.options[t.selectedIndex].text, document.body.appendChild(e), t.style.width = `${e.offsetWidth + 20}px`, document.body.removeChild(e);
  }
  function qa(t) {
    let e = t.target.value, n = window.location.pathname.split("/").pop() + window.location.hash, r = `${e}/${n}`;
    _t(r).then((i) => {
      i ? window.location.href = r : window.location.href = e;
    });
  }
  function Fa(t) {
    let e = this.href, n = window.location.pathname.split("/").pop() + window.location.hash, r = `${e}/${n}`;
    t.preventDefault(), _t(r).then((i) => {
      i ? window.location.href = r : window.location.href = e;
    });
  }
  function dn() {
    let t = f(mi);
    t && (t.focus(), t.addEventListener("keydown", (e) => {
      (e.key === "Escape" || e.key === "v") && (e.preventDefault(), t.blur());
    }), navigator.userActivation.isActive && "showPicker" in HTMLSelectElement.prototype && t.showPicker());
  }
  ...
  function za() {
    let t = [], e = [], n = document.createNodeIterator(
  ...
  function Ka(t) {
    if (gi[t.code]) {
      t.preventDefault();
      let e = [...t.currentTarget.parentNode.childNodes], n = e.indexOf(t.currentTarget), r = gi[t.code](n, e.length);
      vi(e.at(r % e.length));
    }
  }
  var gi = {
  ...
  function vi(t) {
    let e = t.parentNode.querySelector("[aria-selected=true]");
    if (e === t)
      return;
  ...
  function Ya() {
    let t = window.location.pathname.replace(/(\.html)?$/, ".livemd"), e = encodeURIComponent(new URL(t, window.location.href).toString());
    M.getAndSubscribe(({ livebookUrl: n }) => {
      let r = n ? `${n}/import?url=${e}` : `https://livebook.dev/run?url=${e}`;
      for (let i of C(".livebook-badge"))
        i.href = r;
    });
  }
  ...
  function Xa() {
    C("[data-group-id]").forEach((t) => {
      t.addEventListener("mouseenter", yi), t.addEventListener("mouseleave", yi);
    });
  }
  function yi(t) {
    let e = t.currentTarget, n = t.type === "mouseenter", r = e.getAttribute("data-group-id");
    e.parentElement.querySelectorAll(`[data-group-id="${r}"]`).forEach((i) => {
  ...
  function bi(t, e = null) {
    let n = e || window.autocompleteLimit || Za;
    if (he(t))
      return [];
    let r = qe(), i = [
      ...hn(r.modules, t, j.module, "module"),
      ...el(r.modules, t, j.moduleChild),
      ...hn(r.tasks, t, j.mixTask, "mix task"),
      ...hn(r.extras, t, j.extra, "page"),
      ...fn(r.modules, t, j.section, "module"),
      ...fn(r.tasks, t, j.section, "mix task"),
      ...fn(r.extras, t, j.section, "page")
    ].filter((s) => s !== null);
    return al(i).slice(0, n);
  }
  function hn(t, e, n, r) {
    return t.map(
      (i) => i.searchData ? null : nl(i, e, n, r)
    );
  }
  function el(t, e, n) {
    return t.filter((r) => r.nodeGroups).flatMap((r) => r.nodeGroups.flatMap(({ key: i, nodes: s }) => {
      let o = ol(i);
      return s.map(
        (a) => rl(a, r.id, e, n, o) || sl(a, r.id, e, n, o)
      );
    }));
  }
  function fn(t, e, n, r) {
    return t.flatMap(
      (i) => tl(i).map((s) => il(i, s, e, n, r))
    );
  }
  function tl(t) {
    return t.searchData ? t.searchData : (t.sections || []).concat(t.headers || []);
  }
  function nl(t, e, n, r) {
    return ct(t.title, e) ? {
      link: `${t.id}.html`,
  ...
  function il(t, e, n, r, i) {
    if (!Ei(e.id, n))
      return null;
    let s;
    return e.anchor === "" ? s = `${t.id}.html` : s = `${t.id}.html#${e.anchor}`, {
      link: s,
      title: ft(e.id, n),
      description: t.title,
      matchQuality: dt(e.id, n),
      labels: e.labels || [i, "section"],
      category: r
    };
  }
  function sl(t, e, n, r, i) {
    let s = `${e}.${t.id}`, o = `${e}:${t.id}`, a, l;
    if (ct(s, n))
      a = s, l = /\./g;
    else if (ct(o, n))
      a = o, l = /:/g;
  ...
  function al(t) {
    return t.slice().sort((e, n) => e.matchQuality !== n.matchQuality ? n.matchQuality - e.matchQuality : wi(e.category) - wi(n.category));
  }
  function wi(t) {
    switch (t) {
      case j.module:
  ...
  function Ei(t, e) {
    return ht(e).some((r) => xi(t, r));
  }
  function ct(t, e) {
    return ht(e).every((r) => xi(t, r));
  }
  function xi(t, e) {
    return t.toLowerCase().includes(e.toLowerCase());
  }
  function dt(t, e) {
    let n = ht(e), i = n.map((o) => o.length).reduce((o, a) => o + a, 0) / t.length, s = ll(t, n[0]) ? 1 : 0;
    return i + s;
  }
  function ll(t, e) {
  ...
  function ft(t, e) {
    let n = ht(e).sort((r, i) => i.length - r.length);
    return ut(t, n);
  }
  function ut(t, e) {
    if (e.length === 0)
      return t;
    let [n, ...r] = e, i = t.match(new RegExp(`(.*)(${Jn(n)})(.*)`, "i"));
    if (i) {
      let [, s, o, a] = i;
      return ut(s, e) + "<em>" + Ne(o) + "</em>" + ut(a, e);
    } else
      return ut(t, r);
  }
  ...
  var Si = Y(ae());
  var ki = Si.template({ 1: function(t, e, n, r, i) {
...
`;
    ...
    var s, o, a = t.lookupProperty || function(l, u) {
      if (Object.prototype.hasOwnProperty.call(l, u))
        return l[u];
    };
...
`;
    ...
    return '        <span class="label">' + t.escapeExpression(t.lambda(e, e)) + `</span>
`;
  }, compiler: [8, ">= 4.3.0"], main: function(t, e, n, r, i) {
    var s, o = e ?? (t.nullContext || {}), a = t.lookupProperty || function(l, u) {
      if (Object.prototype.hasOwnProperty.call(l, u))
...
`;
  ...
  function gn(t) {
    W.autocompleteSuggestions = bi(t), W.selectedIdx = -1, he(t) ? mn() : (cl({ term: t, suggestions: W.autocompleteSuggestions }), pt(0), ul());
  }
  function cl({ term: t, suggestions: e }) {
    let n = ki({ suggestions: e, term: t }), r = f(pe);
    r.innerHTML = n;
  }
  function _i() {
  ...
  function dl(t) {
    W.selectedIdx = t;
    let e = f(pn), n = f(`${Li}.selected`), r = f(`${Li}[data-index="${W.selectedIdx}"]`);
    n && n.classList.remove("selected"), r ? (r.classList.add("selected"), r.scrollIntoView({ block: "nearest" })) : e && (e.scrollTop = 0);
  }
  function hl(t) {
    let e = W.autocompleteSuggestions.length + 1;
    return (W.selectedIdx + t + 1 + e) % e - 1;
  }
  ...
  R || window.addEventListener("exdoc:loaded", ml);
  function ml() {
    gl(), wl(), yl();
  }
  function gl() {
    let t = document.querySelectorAll(".engine-option");
    if (t.length === 0) {
      vt = "search.html?q=";
      return;
    }
    ...
    vt = t[0].dataset.engineUrl;
  }
  function Ii(t) {
    vt = t.dataset.engineUrl;
    let n = f(Le)?.querySelector(".engine-name");
    n && (n.textContent = t.querySelector(".name").textContent), f(Te)?.querySelectorAll(".engine-option").forEach((i) => {
      i.setAttribute("aria-checked", i === t ? "true" : "false");
    });
  }
  function Pi() {
    let t = f(Le), e = f(Te);
    if (!t || !e)
      return;
    t.getAttribute("aria-expanded") === "true" ? ke() : vl();
  }
  function vl() {
    let t = f(Le), e = f(Te);
    if (!t || !e)
      return;
    t.setAttribute("aria-expanded", "true"), e.removeAttribute("hidden"), e.querySelector(".engine-option")?.focus();
  }
  function ke() {
    let t = f(Le), e = f(Te);
    !t || !e || (t.setAttribute("aria-expanded", "false"), e.setAttribute("hidden", ""));
  }
  function Ci(t) {
    let e = f(me);
    e.value = t;
  ...
  function Ri() {
    let t = f(me);
    document.body.classList.add("search-focused"), t.focus();
  }
  function yl() {
    let t = f(me), e = parseInt(document.querySelector('meta[name="exdoc:autocomplete-limit"]')?.content);
    e && (window.autocompleteLimit = e), t.setAttribute("autocomplete-limit", e);
  }
  function wl() {
    let t = f(me);
    ...
    t.addEventListener("keydown", (r) => {
      let i = Qe();
      r.key === "Escape" ? (mt(), t.blur()) : r.key === "Enter" ? Oi(r) : r.key === "ArrowUp" || i && r.ctrlKey && r.key === "p" ? (pt(-1), r.preventDefault()) : (r.key === "ArrowDown" || i && r.ctrlKey && r.key === "n") && (pt(1), r.preventDefault());
      ...
      r.shiftKey || r.ctrlKey ? t.focus() : (mt(), gt());
    ...
    n && (n.querySelectorAll(".engine-option").forEach((r) => {
      ...
      if (r.key === "ArrowDown") {
        ...
        r.key === "Escape" ? (r.preventDefault(), ke(), e?.focus()) : (r.key === "Enter" || r.key === " ") && (r.preventDefault(), document.activeElement?.click());
    }));
  }
  function Oi(t) {
    let e = f(me), n = t.shiftKey || t.ctrlKey, r = _i();
    t.preventDefault();
    let i = n ? "_blank" : "_self", s = document.createElement("a");
    s.setAttribute("target", i), r ? s.setAttribute("href", r.link) : s.setAttribute("href", `${vt}${encodeURIComponent(e.value)}`), s.click(), n || (mt(), gt());
  }
  function mt() {
    let t = f(me);
    t.value = "";
  ...
  window.addEventListener("scroll", function() {
    ...
    if (vn !== void 0) {
      let e = t - vn;
      t === 0 || e > Ai ? document.body.classList.remove("scroll-sticky") : t > 0 && -e > Ai && document.body.classList.add("scroll-sticky");
    }
    vn = Math.max(0, t);
  }, !1);
  ...
  var Mi = Y(ae());
  var Hi = Mi.template({ 1: function(t, e, n, r, i) {
    var s, o = t.lookupProperty || function(a, l) {
      if (Object.prototype.hasOwnProperty.call(a, l))
        return a[l];
    };
...
`;
    ...
    var s, o = t.lambda, a = t.escapeExpression, l = t.lookupProperty || function(u, c) {
...
` + ((s = l(n, "if").call(e ?? (t.nullContext || {}), (s = e != null ? l(e, "hint") : e) != null ? l(s, "description") : s, { name: "if", hash: {}, fn: t.program(4, i, 0), inverse: t.noop, data: i, loc: { start: { line: 12, column: 2 }, end: { line: 16, column: 9 } } })) != null ? s : "");
  }, 4: function(t, e, n, r, i) {
    var s, o = t.lookupProperty || function(a, l) {
      if (Object.prototype.hasOwnProperty.call(a, l))
        return a[l];
...
`;
    ...
    return (s = o(n, "if").call(e ?? (t.nullContext || {}), e != null ? o(e, "isPlain") : e, { name: "if", hash: {}, fn: t.program(1, i, 0), inverse: t.program(3, i, 0), data: i, loc: { start: { line: 1, column: 0 }, end: { line: 17, column: 7 } } })) != null ? s : "";
  }, useData: !0 });
  ...
  function _l() {
    C(El).forEach((t) => {
      Pl(t) && (t.addEventListener("mouseenter", Al), t.addEventListener("mouseleave", Cl));
    });
  }
  function Pl(t) {
    return !(Ol(t.href) || !jn(t.href));
  }
  function Ol(t) {
    let e = t.replace(xl, "");
    return window.location.href.split("#")[0] === e;
  }
  function Al(t) {
    if (window.innerWidth < kl || window.innerHeight < Ll || !M.get().tooltips)
      return;
    let e = t.currentTarget;
    le.currentLinkElement = e, le.hoverDelayTimeout = setTimeout(() => {
      Wn(e.href).then(Il).catch(() => {
      });
    }, Tl);
  }
  function Il(t) {
    let e = Hi({
      isPlain: t.kind === ie.plain,
      hint: t
    }), n = f(Ni);
    n || (f(Di).insertAdjacentHTML("beforeend", bl), n = f(Ni)), n.innerHTML = e, Rl(), f(yn).classList.add(Bi);
  }
  function Cl() {
  ...
  function Rl() {
    if (!le.currentLinkElement)
      return;
    let t = f(yn), e = le.currentLinkElement.getBoundingClientRect(), n = f(Di).getBoundingClientRect(), r = t.getBoundingClientRect(), i = Ml(e, n);
    if (e.left + r.width + _e < window.innerWidth)
      t.style.left = `${i.left}px`, t.style.right = "auto";
    else {
      let s = Math.max(i.right - r.width, _e);
      t.style.left = `${s}px`, t.style.right = "auto";
    }
    e.bottom + r.height + Sl < window.innerHeight ? t.style.top = `${i.bottom + _e}px` : t.style.top = `${i.top - r.height - _e}px`;
  }
  function Ml(t, e) {
    return {
      top: t.top - e.top,
  ...
  function Hl() {
    "clipboard" in navigator && C("pre:has(> code:first-child):not(:has(.copy-button))").forEach((t) => {
      if (!wn) {
        let r = document.createElement("div");
        r.innerHTML = Qi, wn = r.firstChild;
      }
      let e = wn.cloneNode(!0);
      t.appendChild(e);
      let n;
      e.addEventListener("click", () => {
        clearTimeout(n);
        let r = Array.from(t.querySelectorAll("code > *")).filter((i) => !i.classList.contains("unselectable") || i.textContent !== "$ ").map((i) => i.textContent).join("");
        navigator.clipboard.writeText(r), e.classList.add("clicked"), e.disabled = !0, n = setTimeout(() => {
          e.classList.remove("clicked"), e.disabled = !1;
        }, 3e3);
      });
    });
  }
  ...
  var $i = Y(ae());
  var Ui = $i.template({ 1: function(t, e, n, r, i) {
    var s, o = t.lookupProperty || function(a, l) {
      if (Object.prototype.hasOwnProperty.call(a, l))
        return a[l];
    };
    return "    Search results for <em>" + t.escapeExpression((s = (s = o(n, "value") || (e != null ? o(e, "value") : e)) != null ? s : t.hooks.helperMissing, typeof s == "function" ? s.call(e ?? (t.nullContext || {}), { name: "value", hash: {}, data: i, loc: { start: { line: 3, column: 27 }, end: { line: 3, column: 36 } } }) : s)) + `</em>
`;
  }, 3: function(t, e, n, r, i) {
...
`;
    ...
    return (s = o(n, "each").call(e ?? (t.nullContext || {}), e != null ? o(e, "results") : e, { name: "each", hash: {}, fn: t.program(6, i, 0), inverse: t.noop, data: i, loc: { start: { line: 10, column: 2 }, end: { line: 21, column: 11 } } })) != null ? s : "";
  }, 6: function(t, e, n, r, i) {
    var s, o = t.lambda, a = t.escapeExpression, l = t.lookupProperty || function(u, c) {
      if (Object.prototype.hasOwnProperty.call(u, c))
        return u[c];
...
`;
    ...
    var s;
    return '          <p class="result-elem">' + ((s = t.lambda(e, e)) != null ? s : "") + `</p>
`;
    ...
    return ((s = (o(n, "isArray") || e && o(e, "isArray") || t.hooks.helperMissing).call(e ?? (t.nullContext || {}), e != null ? o(e, "results") : e, { name: "isArray", hash: {}, fn: t.program(10, i, 0), inverse: t.program(12, i, 0), data: i, loc: { start: { line: 23, column: 2 }, end: { line: 29, column: 14 } } })) != null ? s : "") + `
...
`;
    ...
    return "    <p>Sorry, we couldn't find anything for <em>" + t.escapeExpression((s = (s = o(n, "value") || (e != null ? o(e, "value") : e)) != null ? s : t.hooks.helperMissing, typeof s == "function" ? s.call(e ?? (t.nullContext || {}), { name: "value", hash: {}, data: i, loc: { start: { line: 24, column: 48 }, end: { line: 24, column: 57 } } }) : s)) + `</em>.</p>
`;
    ...
    return (s = o(n, "if").call(e ?? (t.nullContext || {}), e != null ? o(e, "value") : e, { name: "if", hash: {}, fn: t.program(13, i, 0), inverse: t.program(15, i, 0), data: i, loc: { start: { line: 25, column: 2 }, end: { line: 29, column: 2 } } })) != null ? s : "";
  }, 13: function(t, e, n, r, i) {
    var s, o = t.lookupProperty || function(a, l) {
      if (Object.prototype.hasOwnProperty.call(a, l))
        return a[l];
    };
    return "    <p>Invalid search: " + t.escapeExpression((s = (s = o(n, "errorMessage") || (e != null ? o(e, "errorMessage") : e)) != null ? s : t.hooks.helperMissing, typeof s == "function" ? s.call(e ?? (t.nullContext || {}), { name: "errorMessage", hash: {}, data: i, loc: { start: { line: 26, column: 23 }, end: { line: 26, column: 39 } } }) : s)) + `.</p>
`;
...
` + ((s = (a(n, "isNonEmptyArray") || e && a(e, "isNonEmptyArray") || t.hooks.helperMissing).call(o, e != null ? a(e, "results") : e, { name: "isNonEmptyArray", hash: {}, fn: t.program(5, i, 0), inverse: t.program(9, i, 0), data: i, loc: { start: { line: 9, column: 0 }, end: { line: 44, column: 20 } } })) != null ? s : "");
  }, useData: !0 });
  ...
  async function Bl(t) {
    if (he(t))
      ...
      let e = await Ql();
      try {
        let n = t.replaceAll(/(\B|\\):/g, "\\:"), r = Kl(e.search(n));
        bn({ value: t, results: r });
      } catch (n) {
        bn({ value: t, errorMessage: n.message });
      }
    }
  }
  function bn({ value: t, results: e, errorMessage: n }) {
    let r = f(Nl), i = Ui({ value: t, results: e, errorMessage: n });
    r.innerHTML = i;
  }
  async function Ql() {
    let t = await ql();
  ...
  async function ql() {
    try {
      let t = sessionStorage.getItem(Wi());
      if (t) {
        let e = await $l(t);
        return F.default.Index.load(e);
      } else
        return null;
    } catch (t) {
      return console.error("Failed to load index: ", t), null;
    }
  }
  async function Fl(t) {
    try {
      let e = await Vl(t);
      sessionStorage.setItem(Wi(), e);
    } catch (e) {
  ...
  async function Vl(t) {
    ...
    }).stream().pipeThrough(new window.CompressionStream("gzip")), r = await (await new Response(e).blob()).arrayBuffer();
    return Ul(r);
  }
  async function $l(t) {
    let e = new Blob([jl(t)], {
      type: "application/json"
    }).stream().pipeThrough(new window.DecompressionStream("gzip")), n = await new Response(e).text();
    return JSON.parse(n);
  }
  function Ul(t) {
    let e = "", n = new Uint8Array(t), r = n.byteLength;
    for (let i = 0; i < r; i++)
      e += String.fromCharCode(n[i]);
    return window.btoa(e);
  }
  function jl(t) {
    let e = window.atob(t), n = e.length, r = new Uint8Array(new ArrayBuffer(n));
    for (let i = 0; i < n; i++)
      r[i] = e.charCodeAt(i);
    return r;
  }
  ...
  function Wl() {
    return (0, F.default)(function() {
      this.ref("ref"), this.field("title", { boost: 3 }), this.field("doc"), this.field("type"), this.metadataWhitelist = ["position"], this.pipeline.remove(F.default.stopWordFilter), this.pipeline.remove(F.default.trimmer), this.use(zl), this.use(Gl), searchData.items.forEach((t) => {
        this.add(t);
      });
    });
  }
  function zl(t) {
    t.pipeline.before(F.default.stemmer, zi);
  }
  function zi(t) {
    let e = [t], n = /\/\d+$/, r = /\:|\./, i = t.toString();
    if (i.replace(/^[.,;?!]+|[.,;]+$/g, ""), i.startsWith("`") && i.endsWith("`") && (i = i.slice(1, -1)), n.test(i)) {
      let o = t.toString().replace(n, "");
      e.push(t.clone().update(() => o));
      let a = o.split(r);
      if (a.length > 1) {
        for (let u of a)
          e.push(t.clone().update(() => u));
        let l = t.toString().split(r);
        e.push(t.clone().update(() => l[l.length - 1]));
      }
      i = a[a.length - 1];
    } else
      i.startsWith("@") ? (i = i.substring(1), e.push(t.clone().update(() => i))) : i.startsWith(":") && (i = i.substring(1), e.push(t.clone().update(() => i)));
    let s = i.split(/\_|\-/);
    if (s.length > 1)
      for (let o of s)
        e.push(t.clone().update(() => o));
  ...
  function Gl(t) {
    t.pipeline.before(F.default.stemmer, Gi);
  }
  function Gi(t) {
  ...
  function Kl(t) {
    return t.filter((e) => ji(e.ref)).map((e) => {
      let n = ji(e.ref), r = e.matchData.metadata;
      return {
        ...n,
        metadata: r,
        excerpts: Yl(n, r)
  ...
  function ji(t) {
    return searchData.items.find((e) => e.ref === t) || null;
  }
  function Yl(t, e) {
    let { doc: n } = t, r = Object.keys(e);
    return [Jl(n, r)];
  }
  function Jl(t, e) {
    let r = t.split(`\r
...
`)), i;
    r.length >= 2 ? r[0].trim().startsWith("#") ? i = r[1] : i = r[0] : r.length === 1 ? i = r[0] : i = t;
    let s;
  ...
  // js/modal.js
  var Xl = 'button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])', H = null, Sn = null, En = null, xn = !1;
  function Zl() {
    H || (document.body.insertAdjacentHTML("beforeend", Ki), H = f(".modal"), H.addEventListener("keydown", (t) => {
      t.key === "Escape" && ue();
    }), H.querySelector(".modal-close").addEventListener("click", ue), H.addEventListener("click", (t) => {
      t.target === H && ue();
    }));
  }
  function Yi(t) {
    if (!xn)
      if (H.contains(t.target))
        En = t.target;
      else {
        xn = !0;
        let e = H.querySelectorAll(Xl);
        En === e[0] ? e[e.length - 1].focus() : e[0].focus(), xn = !1, En = document.activeElement;
      }
  }
  function yt({ title: t, body: e }) {
    Zl(), Sn = document.activeElement, document.addEventListener("focus", Yi, !0), H.querySelector(".modal-title").innerHTML = t, H.querySelector(".modal-body").innerHTML = e, H.classList.add("shown"), H.focus();
  }
  function ue() {
    H?.classList.remove("shown"), document.removeEventListener("focus", Yi, !0), Sn?.focus(), Sn = null;
  }
  function Ji() {
    return Boolean(H?.classList.contains("shown"));
  }
  ...
  var eu = "https://hexdocs.pm/%%", tu = "https://www.erlang.org/doc/apps/%%", nu = "https://hex.pm/api/packages?search=name:%%*", ru = ".display-quick-switch", es = "#quick-switch-input", ts = "#quick-switch-results", iu = 300, su = 9, ns = [
    ...
    "logger",
    "mix"
  ].concat(ns).map((t) => ({ name: t })), rs = 2, D = {
    autocompleteResults: [],
    selectedIdx: null
  };
  R || window.addEventListener("exdoc:loaded", au);
  function au() {
    C(ru).forEach((t) => {
  ...
  function lu(t) {
    if (t.key === "Enter") {
      ...
      cu(e), t.preventDefault();
    } else
      t.key === "ArrowUp" ? (Zi(-1), t.preventDefault()) : t.key === "ArrowDown" && (Zi(1), t.preventDefault());
  }
  function uu(t) {
    let e = t.target.value;
    if (e.length < rs) {
  ...
  function Ln() {
    ...
    let t = f(es);
    t.focus(), t.addEventListener("keydown", lu), t.addEventListener("input", uu), D.autocompleteResults = [], D.selectedIdx = null;
  }
  function cu(t) {
    if (D.selectedIdx === null)
      kn(t);
    else {
      let e = D.autocompleteResults[D.selectedIdx];
      kn(e.name);
    }
  }
  function kn(t) {
    ns.includes(t.toLowerCase()) ? window.location = tu.replace("%%", t.toLowerCase()) : window.location = eu.replace("%%", t.toLowerCase());
  }
  var du = er(hu, iu);
  function hu(t) {
    let e = nu.replace("%%", t);
    fetch(e).then((n) => n.json()).then((n) => {
      Array.isArray(n) && (D.autocompleteResults = pu(t, n), D.selectedIdx = null, f(es).value.length >= rs && fu(D.autocompleteResults));
    });
  }
  function fu(t) {
    f(ts).replaceChildren(...t.map(({ name: e }, n) => {
      let r = E("div", { class: "quick-switch-result", "data-index": n }, [e]);
      return r.addEventListener("click", () => kn(e)), r;
    }));
  }
  function pu(t, e) {
    return ou.concat(e).filter((n) => n.name.toLowerCase().includes(t.toLowerCase())).filter((n) => n.releases === void 0 || n.releases[0].has_docs === !0).slice(0, su);
  }
  function Zi(t) {
    D.selectedIdx = mu(t);
    let e = f(".quick-switch-result.selected"), n = f(`.quick-switch-result[data-index="${D.selectedIdx}"]`);
    e && e.classList.remove("selected"), n && n.classList.add("selected");
  }
  function mu(t) {
    let e = D.autocompleteResults.length;
    if (D.selectedIdx === null) {
      if (t >= 0)
        return 0;
      if (t < 0)
  ...
  R || (document.addEventListener("keydown", vu), document.addEventListener("keyup", yu));
  function vu(t) {
    if (_n.shortcutBeingPressed || t.target.matches("input, select, textarea"))
      return;
    let e = Pn.find((n) => n.hasModifier ? Qe() && t.metaKey || t.ctrlKey ? n.key === t.key : !1 : t.ctrlKey || t.metaKey || t.altKey ? !1 : n.key === t.key);
    e && (_n.shortcutBeingPressed = e, t.preventDefault(), e.action(t));
  }
  function yu(t) {
  ...
  var is = Y(ae());
  var ss = is.template({ 1: function(t, e, n, r, i) {
    var s, o = t.lookupProperty || function(a, l) {
      if (Object.prototype.hasOwnProperty.call(a, l))
        return a[l];
    };
    return (s = o(n, "if").call(e ?? (t.nullContext || {}), e != null ? o(e, "description") : e, { name: "if", hash: {}, fn: t.program(2, i, 0), inverse: t.noop, data: i, loc: { start: { line: 40, column: 6 }, end: { line: 53, column: 13 } } })) != null ? s : "";
  }, 2: function(t, e, n, r, i) {
    var s, o = t.lookupProperty || function(a, l) {
      if (Object.prototype.hasOwnProperty.call(a, l))
        return a[l];
...
`;
    ...
    return "              " + ((s = t.lambda(e != null ? o(e, "displayAs") : e, e)) != null ? s : "") + `
`;
  }, 5: function(t, e, n, r, i) {
    var s = t.lookupProperty || function(o, a) {
      if (Object.prototype.hasOwnProperty.call(o, a))
        return o[a];
    };
    return "              <kbd><kbd>" + t.escapeExpression(t.lambda(e != null ? s(e, "key") : e, e)) + `</kbd></kbd>
`;
  }, compiler: [8, ">= 4.3.0"], main: function(t, e, n, r, i) {
    var s, o = t.lookupProperty || function(a, l) {
      if (Object.prototype.hasOwnProperty.call(a, l))
...
`;
  ...
  function On() {
    ...
    let t = f(Su), e = t.querySelector('[name="theme"]'), n = t.querySelector('[name="tooltips"]'), r = t.querySelector('[name="direct_livebook_url"]'), i = t.querySelector('[name="livebook_url"]');
    M.getAndSubscribe((s) => {
      e.value = s.theme || "system", n.checked = s.tooltips, s.livebookUrl === null ? (r.checked = !1, i.classList.add("hidden"), i.tabIndex = -1) : (r.checked = !0, i.classList.remove("hidden"), i.tabIndex = 0, i.value = s.livebookUrl);
    }), e.addEventListener("change", (s) => {
      M.update({ theme: s.target.value });
    }), n.addEventListener("change", (s) => {
      M.update({ tooltips: s.target.checked });
    }), r.addEventListener("change", (s) => {
      let o = s.target.checked ? i.value : null;
      M.update({ livebookUrl: o });
    }), i.addEventListener("input", (s) => {
      M.update({ livebookUrl: s.target.value });
  ...
  function Rn(t, e, n, r) {
    if (!t && !Cn.has(e))
      return !1;
    let i = Cn.get(e) ?? /* @__PURE__ */ new WeakMap();
    Cn.set(e, i);
    let s = i.get(n) ?? /* @__PURE__ */ new Set();
    i.set(n, s);
    let o = s.has(r);
    return t ? s.add(r) : s.delete(r), o && t;
  }
  function _u(t, e) {
    let n = t.target;
  ...
  function Pu(t, e, n, r = {}) {
    ...
    if (i?.aborted)
      return;
    let { once: o, ...a } = r, l = s instanceof Document ? s.documentElement : s, u = Boolean(typeof r == "object" ? r.capture : r), c = (p) => {
      let g = _u(p, String(t));
      if (g) {
        let m = Object.assign(p, { delegateTarget: g });
        n.call(l, m), o && (l.removeEventListener(e, c, a), Rn(!1, l, n, d));
      }
    }, d = JSON.stringify({ selector: t, type: e, capture: u });
    Rn(!0, l, n, d) || l.addEventListener(e, c, a), i?.addEventListener("abort", () => {
      Rn(!1, l, n, d);
    });
  }
  var wt = Pu;
  ...
  var hs = (t, e) => String(t).toLowerCase().replace(/[\s/_.]+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+|-+$/g, "") || e || "", Oe = ({ hash: t } = {}) => window.location.pathname + window.location.search + (t ? window.location.hash : ""), Ou = (t, e = {}) => {
    let n = O({ url: t = t || Oe({ hash: !0 }), random: Math.random(), source: "swup" }, e);
    window.history.pushState(n, "", t);
  }, Pe = (t = null, e = {}) => {
    t = t || Oe({ hash: !0 });
    let n = O({}, window.history.state || {}, { url: t, random: Math.random(), source: "swup" }, e);
    window.history.replaceState(n, "", t);
  }, Au = (t, e, n, r) => {
    let i = new AbortController();
    return r = O({}, r, { signal: i.signal }), wt(t, e, n, r), { destroy: () => i.abort() };
  }, A = class extends URL {
    constructor(e, n = document.baseURI) {
      super(e.toString(), n), Object.setPrototypeOf(this, A.prototype);
    }
    get url() {
      return this.pathname + this.search;
    }
    static fromElement(e) {
      let n = e.getAttribute("href") || e.getAttribute("xlink:href") || "";
      return new A(n);
    }
    static fromUrl(e) {
      return new A(e);
  ...
  var ge = class extends Error {
    constructor(e, n) {
      super(e), this.url = void 0, this.status = void 0, this.aborted = void 0, this.timedOut = void 0, this.name = "FetchError", this.url = n.url, this.status = n.status, this.aborted = n.aborted || !1, this.timedOut = n.timedOut || !1;
    }
  };
  async function Iu(t, e = {}) {
    var n;
    t = A.fromUrl(t).url;
    let { visit: r = this.visit } = e, i = O({}, this.options.requestHeaders, e.headers), s = (n = e.timeout) != null ? n : this.options.timeout, o = new AbortController(), { signal: a } = o;
    e = O({}, e, { headers: i, signal: a });
    let l, u = !1, c = null;
    s && s > 0 && (c = setTimeout(() => {
      u = !0, o.abort("timeout");
    }, s));
    try {
      l = await this.hooks.call("fetch:request", r, { url: t, options: e }, (v, { url: w, options: x }) => fetch(w, x)), c && clearTimeout(c);
    } catch (v) {
      throw u ? (this.hooks.call("fetch:timeout", r, { url: t }), new ge(`Request timed out: ${t}`, { url: t, timedOut: u })) : v?.name === "AbortError" || a.aborted ? new ge(`Request aborted: ${t}`, { url: t, aborted: !0 }) : v;
    }
    let { status: d, url: h } = l, p = await l.text();
    if (d === 500)
      throw this.hooks.call("fetch:error", r, { status: d, response: l, url: h }), new ge(`Server error: ${h}`, { status: d, url: h });
    if (!p)
      throw new ge(`Empty response: ${h}`, { status: d, url: h });
    let { url: g } = A.fromUrl(h), m = { url: g, html: p };
    return !r.cache.write || e.method && e.method !== "GET" || t !== g || this.cache.set(m.url, m), m;
  }
  var Hn = class {
    constructor(e) {
    ...
    get(e) {
      let n = this.pages.get(this.resolve(e));
      return n && O({}, n);
    }
    set(e, n) {
      n = O({}, n, { url: e = this.resolve(e) }), this.pages.set(e, n), this.swup.hooks.callSync("cache:set", void 0, { page: n });
    }
    update(e, n) {
      e = this.resolve(e);
      let r = O({}, this.get(e), n, { url: e });
      this.pages.set(e, r);
    }
    delete(e) {
    ...
    resolve(e) {
      let { url: n } = A.fromUrl(e);
      return this.swup.resolveUrl(n);
    }
  }, Nn = (t, e = document) => e.querySelector(t), Qn = (t, e = document) => Array.from(e.querySelectorAll(t)), fs = () => new Promise((t) => {
  ...
  function us(t, e) {
    let n = t?.closest(`[${e}]`);
    return n != null && n.hasAttribute(e) ? n?.getAttribute(e) || !0 : void 0;
  }
  var Dn = class {
    constructor(e) {
    ...
    add(...e) {
      this.targets.forEach((n) => n.classList.add(...e));
    }
    remove(...e) {
      this.targets.forEach((n) => n.classList.remove(...e));
    }
    clear() {
      this.targets.forEach((e) => {
        let n = e.className.split(" ").filter((r) => this.isSwupClass(r));
        e.classList.remove(...n);
      });
    }
    isSwupClass(e) {
      return this.swupClasses.some((n) => e.startsWith(n));
    }
  }, xt = class {
    constructor(e, n) {
      ...
      this.id = Math.random(), this.state = 1, this.from = { url: i ?? e.location.url, hash: e.location.hash }, this.to = { url: r, hash: s }, this.containers = e.options.containers, this.animation = { animate: !0, wait: !1, name: void 0, native: e.options.native, scope: e.options.animationScope, selector: e.options.animationSelector }, this.trigger = { el: o, event: a }, this.cache = { read: e.options.cache, write: e.options.cache }, this.history = { action: "push", popstate: !1, direction: void 0 }, this.scroll = { reset: !0, target: void 0 }, this.meta = {};
    }
    advance(e) {
  ...
  var Bn = class {
    constructor(e) {
      this.swup = void 0, this.registry = /* @__PURE__ */ new Map(), this.hooks = ["animation:out:start", "animation:out:await", "animation:out:end", "animation:in:start", "animation:in:await", "animation:in:end", "animation:skip", "cache:clear", "cache:set", "content:replace", "content:scroll", "enable", "disable", "fetch:request", "fetch:error", "fetch:timeout", "history:popstate", "link:click", "link:self", "link:anchor", "link:newtab", "page:load", "page:view", "scroll:top", "scroll:anchor", "visit:start", "visit:transition", "visit:abort", "visit:end"], this.swup = e, this.init();
    }
    init() {
    ...
    on(e, n, r = {}) {
      ...
      let s = O({}, r, { id: i.size + 1, hook: e, handler: n });
      return i.set(n, s), () => this.off(e, n);
    }
    before(e, n, r = {}) {
      return this.on(e, n, O({}, r, { before: !0 }));
    }
    replace(e, n, r = {}) {
      return this.on(e, n, O({}, r, { replace: !0 }));
    }
    once(e, n, r = {}) {
      return this.on(e, n, O({}, r, { once: !0 }));
    }
    off(e, n) {
      let r = this.get(e);
      r && n ? r.delete(n) || console.warn(`Handler for hook '${e}' not found.`) : r && r.clear();
    }
    async call(e, n, r, i) {
      let [s, o, a] = this.parseCallArgs(e, n, r, i), { before: l, handler: u, after: c } = this.getHandlers(e, a);
      await this.run(l, s, o);
      let [d] = await this.run(u, s, o, !0);
      return await this.run(c, s, o), this.dispatchDomEvent(e, s, o), d;
    }
    callSync(e, n, r, i) {
      let [s, o, a] = this.parseCallArgs(e, n, r, i), { before: l, handler: u, after: c } = this.getHandlers(e, a);
      this.runSync(l, s, o);
      let [d] = this.runSync(u, s, o, !0);
      return this.runSync(c, s, o), this.dispatchDomEvent(e, s, o), d;
    }
    parseCallArgs(e, n, r, i) {
      return n instanceof xt || typeof n != "object" && typeof r != "function" ? [n, r, i] : [void 0, n, r];
    }
    async run(e, n = this.swup.visit, r, i = !1) {
      let s = [];
      for (let { hook: o, handler: a, defaultHandler: l, once: u } of e)
        if (n == null || !n.done) {
          u && this.off(o, a);
          try {
    ...
    runSync(e, n = this.swup.visit, r, i = !1) {
      let s = [];
      for (let { hook: o, handler: a, defaultHandler: l, once: u } of e)
        if (n == null || !n.done) {
          u && this.off(o, a);
    ...
    getHandlers(e, n) {
      ...
      if (n && (c = [{ id: 0, hook: e, handler: n }], u)) {
        let d = a.length - 1, { handler: h, once: p } = a[d], g = (m) => {
          let v = a[m - 1];
          return v ? (w, x) => v.handler(w, x, g(m - 1)) : n;
        };
        c = [{ id: 0, hook: e, once: p, handler: h, defaultHandler: g(d) }];
      }
      return { found: !0, before: o, handler: c, after: l, replaced: u };
    }
    sortRegistrations(e, n) {
      var r, i;
      return ((r = e.priority) != null ? r : 0) - ((i = n.priority) != null ? i : 0) || e.id - n.id || 0;
    }
    dispatchDomEvent(e, n, r) {
      if (n != null && n.done)
        return;
      let i = { hook: e, args: r, visit: n || this.swup.visit };
      document.dispatchEvent(new CustomEvent("swup:any", { detail: i, bubbles: !0 })), document.dispatchEvent(new CustomEvent(`swup:${e}`, { detail: i, bubbles: !0 }));
    }
    parseName(e) {
      let [n, ...r] = e.split(".");
    ...
    if (t && t.charAt(0) === "#" && (t = t.substring(1)), !t)
      return null;
    let e = decodeURIComponent(t), n = document.getElementById(t) || document.getElementById(e) || Nn(`a[name='${CSS.escape(t)}']`) || Nn(`a[name='${CSS.escape(e)}']`);
    return n || t !== "top" || (n = document.body), n;
  }, bt = "transition", Mn = "animation";
  async function Hu({ selector: t, elements: e }) {
    if (t === !1 && !e)
      return;
    let n = [];
    if (e)
      n = Array.from(e);
    else if (t && (n = Qn(t, document.body), !n.length))
    ...
    r.filter(Boolean).length > 0 ? await Promise.all(r) : t && console.warn(`[swup] No CSS animation duration defined on elements matching \`${t}\``);
  }
  function Et(t, e) {
    return (t[e] || "").split(", ");
  }
  function cs(t, e) {
    for (; t.length < e.length; )
      t = t.concat(t);
    return Math.max(...e.map((n, r) => ds(n) + ds(t[r])));
  }
  function ds(t) {
  ...
  function Nu(t, e = {}, n = {}) {
    ...
    let { url: r, hash: i } = A.fromUrl(t), s = this.createVisit(O({}, n, { to: r, hash: i }));
  ...
  async function Du(t, e = {}) {
    ...
    let { el: n } = t.trigger;
    e.referrer = e.referrer || this.location.url, e.animate === !1 && (t.animation.animate = !1), t.animation.animate || this.classes.clear();
    let r = e.history || us(n, "data-swup-history");
    typeof r == "string" && ["push", "replace"].includes(r) && (t.history.action = r);
    let i = e.animation || us(n, "data-swup-animation");
    var s, o;
    typeof i == "string" && (t.animation.name = i), t.meta = e.meta || {}, typeof e.cache == "object" ? (t.cache.read = (s = e.cache.read) != null ? s : t.cache.read, t.cache.write = (o = e.cache.write) != null ? o : t.cache.write) : e.cache !== void 0 && (t.cache = { read: !!e.cache, write: !!e.cache }), delete e.cache;
    try {
      await this.hooks.call("visit:start", t, void 0), t.state = 3;
      let a = this.hooks.call("page:load", t, { options: e }, async (u, c) => {
        let d;
        return u.cache.read && (d = this.cache.get(u.to.url)), c.page = d || await this.fetchPage(u.to.url, c.options), c.cache = !!d, c.page;
      });
      a.then(({ html: u }) => {
        t.advance(5), t.to.html = u, t.to.document = new DOMParser().parseFromString(u, "text/html");
      });
      let l = t.to.url + t.to.hash;
      if (t.history.popstate || (t.history.action === "replace" || t.to.url === this.location.url ? Pe(l) : (this.currentHistoryIndex++, Ou(l, { index: this.currentHistoryIndex }))), this.location = A.fromUrl(l), t.history.popstate && this.classes.add("is-popstate"), t.animation.name && this.classes.add(`to-${hs(t.animation.name)}`), t.animation.wait && await a, t.done || (await this.hooks.call("visit:transition", t, void 0, async () => {
        if (!t.animation.animate)
          return await this.hooks.call("animation:skip", void 0), void await this.renderPage(t, await a);
        t.advance(4), await this.animatePageOut(t), t.animation.native && document.startViewTransition ? await document.startViewTransition(async () => await this.renderPage(t, await a)).finished : await this.renderPage(t, await a), await this.animatePageIn(t);
      }), t.done))
        return;
      ...
      if (!a || a != null && a.aborted)
        return void (t.state = 8);
      t.state = 9, console.error(a), this.options.skipPopStateHandling = () => (window.location.assign(t.to.url + t.to.hash), !0), window.history.back();
    } finally {
      delete t.to.document;
    }
  }
  var Bu = async function(t) {
    await this.hooks.call("animation:out:start", t, void 0, () => {
      this.classes.add("is-changing", "is-animating", "is-leaving");
    }), await this.hooks.call("animation:out:await", t, { skip: !1 }, (e, { skip: n }) => {
      if (!n)
    ...
    if (!n)
      return !1;
    let r = ((e = n.querySelector("title")) == null ? void 0 : e.innerText) || "";
    document.title = r;
    let i = Qn('[data-swup-persist]:not([data-swup-persist=""])'), s = t.containers.map((o) => {
    ...
    let e = { behavior: "auto" }, { target: n, reset: r } = t.scroll, i = n ?? t.to.hash, s = !1;
    return i && (s = this.hooks.callSync("scroll:anchor", t, { hash: i, options: e }, (o, { hash: a, options: l }) => {
      let u = this.getAnchorElement(a);
      return u && u.scrollIntoView(l), !!u;
    })), r && !s && (s = this.hooks.callSync("scroll:top", t, { options: e }, (o, { options: a }) => (window.scrollTo(O({ top: 0, left: 0 }, a)), !0))), s;
  }, Fu = async function(t) {
    if (t.done)
      return;
    let e = this.hooks.call("animation:in:await", t, { skip: !1 }, (n, { skip: r }) => {
      if (!r)
        return this.awaitAnimations({ selector: n.animation.selector });
    });
    await fs(), await this.hooks.call("animation:in:start", t, void 0, () => {
      this.classes.remove("is-animating");
    }), await e, await this.hooks.call("animation:in:end", t, void 0);
  }, Vu = async function(t, e) {
    if (t.done)
      return;
    t.advance(6);
    let { url: n } = e;
    this.isSameResolvedUrl(Oe(), n) || (Pe(n), this.location = A.fromUrl(n), t.to.url = this.location.url, t.to.hash = this.location.hash), await this.hooks.call("content:replace", t, { page: e }, (r, {}) => {
      if (this.classes.remove("is-leaving"), r.animation.animate && this.classes.add("is-rendering"), !this.replaceContent(r))
  ...
  function Uu(t) {
    let e = this.findPlugin(t);
    if (e)
      return e.unmount(), e._afterUnmount && e._afterUnmount(), this.plugins = this.plugins.filter((n) => n !== e), this.plugins;
  ...
  function Wu(t) {
    ...
    let e = this.options.resolveUrl(t);
  ...
  var Gu = { animateHistoryBrowsing: !1, animationSelector: '[class*="transition-"]', animationScope: "html", cache: !0, containers: ["#swup"], hooks: {}, ignoreVisit: (t, { el: e } = {}) => !(e == null || !e.closest("[data-no-swup]")), linkSelector: "a[href]", linkToSelf: "scroll", native: !1, plugins: [], resolveUrl: (t) => t, requestHeaders: { "X-Requested-With": "swup", Accept: "text/html, application/xhtml+xml" }, skipPopStateHandling: (t) => {
    var e;
    return ((e = t.state) == null ? void 0 : e.source) !== "swup";
  }, timeout: 0 }, St = class {
    get currentPageUrl() {
    ...
    constructor(e = {}) {
      var n, r;
      this.version = "4.8.1", this.options = void 0, this.defaults = Gu, this.plugins = [], this.visit = void 0, this.cache = void 0, this.hooks = void 0, this.classes = void 0, this.location = A.fromUrl(window.location.href), this.currentHistoryIndex = void 0, this.clickDelegate = void 0, this.navigating = !1, this.onVisitEnd = void 0, this.use = $u, this.unuse = Uu, this.findPlugin = ju, this.log = () => {
    ...
    async enable() {
      ...
      ((e = window.history.state) == null ? void 0 : e.source) !== "swup" && Pe(null, { index: this.currentHistoryIndex }), await fs(), await this.hooks.call("enable", void 0, void 0, () => {
        let r = document.documentElement;
        r.classList.add("swup-enabled"), r.classList.toggle("swup-native", this.options.native);
      });
    }
    async destroy() {
      this.clickDelegate.destroy(), window.removeEventListener("popstate", this.handlePopState), this.cache.clear(), this.options.plugins.forEach((e) => this.unuse(e)), await this.hooks.call("disable", void 0, void 0, () => {
        let e = document.documentElement;
        e.classList.remove("swup-enabled"), e.classList.remove("swup-native");
      }), this.hooks.clear();
    }
    shouldIgnoreVisit(e, { el: n, event: r } = {}) {
      let { origin: i, url: s, hash: o } = A.fromUrl(e);
      return i !== window.location.origin || !(!n || !this.triggerWillOpenNewWindow(n)) || !!this.options.ignoreVisit(s + o, { el: n, event: r });
    }
    handleLinkClick(e) {
      let n = e.delegateTarget, { href: r, url: i, hash: s } = A.fromElement(n);
      if (this.shouldIgnoreVisit(r, { el: n, event: e }))
        return;
      if (this.navigating && i === this.visit.to.url)
        return void e.preventDefault();
      let o = this.createVisit({ to: i, hash: s, el: n, event: e });
      e.metaKey || e.ctrlKey || e.shiftKey || e.altKey ? this.hooks.callSync("link:newtab", o, { href: r }) : e.button === 0 && this.hooks.callSync("link:click", o, { el: n, event: e }, () => {
        var a;
        let l = (a = o.from.url) != null ? a : "";
        e.preventDefault(), i && i !== l ? this.isSameResolvedUrl(i, l) || this.performNavigation(o) : s ? this.hooks.callSync("link:anchor", o, { hash: s }, () => {
    ...
    handlePopState(e) {
      var n, r, i, s;
      let o = (n = (r = e.state) == null ? void 0 : r.url) != null ? n : window.location.href;
      if (this.options.skipPopStateHandling(e) || this.isSameResolvedUrl(Oe(), this.location.url))
        return;
      let { url: a, hash: l } = A.fromUrl(o), u = this.createVisit({ to: a, hash: l, event: e });
      u.history.popstate = !0;
      let c = (i = (s = e.state) == null ? void 0 : s.index) != null ? i : 0;
      c && c !== this.currentHistoryIndex && (u.history.direction = c - this.currentHistoryIndex > 0 ? "forwards" : "backwards", this.currentHistoryIndex = c), u.animation.animate = !1, u.scroll.reset = !1, u.scroll.target = !1, this.options.animateHistoryBrowsing && (u.animation.animate = !0, u.scroll.reset = !0), this.hooks.callSync("history:popstate", u, { event: e }, () => {
  ...
  var ms = (t) => String(t).split(".").map((e) => String(parseInt(e || "0", 10))).concat(["0", "0"]).slice(0, 3).join("."), ve = class {
    constructor() {
    ...
    _checkRequirements() {
      return typeof this.requires != "object" || Object.entries(this.requires).forEach(([e, n]) => {
        if (!function(r, i, s) {
          let o = function(a, l) {
            var u;
            if (a === "swup")
              return (u = l.version) != null ? u : "";
            {
              var c;
    ...
    on(e, n, r = {}) {
      ...
      let s = this.swup.hooks.on(e, n, r);
      return this.handlersToUnregister.push(s), s;
    }
    once(e, n, r = {}) {
      return this.on(e, n, Ae({}, r, { once: !0 }));
    }
    before(e, n, r = {}) {
      return this.on(e, n, Ae({}, r, { before: !0 }));
    }
    replace(e, n, r = {}) {
      return this.on(e, n, Ae({}, r, { replace: !0 }));
    }
    off(e, n) {
      return this.swup.hooks.off(e, n);
    }
  };
  ...
  (function() {
    if (!(typeof window > "u" || typeof document > "u" || typeof HTMLElement > "u")) {
      ...
      if (HTMLElement.prototype.nativeFocus === void 0 && !t) {
  ...
  function gs(t, e) {
    return Object.keys(e).reduce((n, r) => n.replace(`{${r}}`, e[r] || ""), t || "");
  }
  var Fn = class {
    constructor() {
      var e;
    ...
    announce(e, n = 0) {
      return new Promise((r) => {
        setTimeout(() => {
          this.region.textContent === e && (e = `${e}.`), this.region.textContent = "", this.region.textContent = e, r();
        }, n);
      });
    }
  };
  function vs(t) {
    let e;
    if (e = typeof t == "string" ? document.querySelector(t) : t, !(e instanceof HTMLElement))
      return;
    let n = e.getAttribute("tabindex");
    e.setAttribute("tabindex", "-1"), e.focus({ preventScroll: !0 }), n !== null && e.setAttribute("tabindex", n);
  }
  var kt = class extends ve {
    constructor(e = {}) {
      ...
      }, this.options = qn({}, this.defaults, e), this.announcer = new Fn();
    }
    mount() {
    ...
    async announce(e) {
      await this.announcer.announce(e);
    }
    markAsBusy() {
    ...
    prepareVisit(e) {
      e.a11y = { announce: void 0, focus: this.rootSelector };
    }
    announceContent(e) {
      this.swup.hooks.callSync("content:announce", e, void 0, (n) => {
    ...
    focusContent(e) {
      this.swup.hooks.callSync("content:focus", e, void 0, (n) => {
        n.a11y.focus && (this.options.autofocus && function() {
          let r = function() {
            let i = document.querySelector("body [autofocus]");
            if (i && !i.closest('[inert], [aria-disabled], [aria-hidden="true"]'))
              return i;
          }();
    ...
    getPageAnnouncement() {
      let { headingSelector: e, announcements: n } = this.options;
      return function({ headingSelector: r = "h1", announcements: i = {} }) {
        var s, o;
        let a = document.documentElement.lang || "*", { href: l, url: u, pathname: c } = A.fromUrl(window.location.href), d = (s = (o = i[a]) != null ? o : i["*"]) != null ? s : i;
        if (typeof d != "object")
          return;
      ...
      }({ headingSelector: e, announcements: n });
    }
    disableAnimations(e) {
  ...
  function Vn() {
    return Vn = Object.assign ? Object.assign.bind() : function(t) {
      for (var e = 1; e < arguments.length; e++) {
        var n = arguments[e];
        for (var r in n)
          Object.prototype.hasOwnProperty.call(n, r) && (t[r] = n[r]);
  ...
  var $n = class {
    constructor({ className: e, styleAttr: n, animationDuration: r, minValue: i, initialValue: s, trickleValue: o } = {}) {
      ...
      }, e !== void 0 && (this.className = String(e)), n !== void 0 && (this.styleAttr = String(n)), r !== void 0 && (this.animationDuration = Number(r)), i !== void 0 && (this.minValue = Number(i)), s !== void 0 && (this.initialValue = Number(s)), o !== void 0 && (this.trickleValue = Number(o)), this.styleElement = this.createStyleElement(), this.progressElement = this.createProgressElement();
    }
    get defaultStyles() {
      return `
		.${this.className} {
    ...
    setValue(e) {
      this.value = Math.min(1, Math.max(this.minValue, e)), this.refresh();
    }
    installStyleElement() {
    ...
    fadeProgressElement(e) {
      this.progressElement.style.opacity = "0", setTimeout(e, 1.5 * this.animationDuration);
    }
    ...
    createStyleElement() {
      ...
      return this.styleAttr.split(" ").forEach((n) => e.setAttribute(n, "")), e.textContent = this.defaultStyles, e;
    }
    createProgressElement() {
      let e = document.createElement("div");
      return e.className = this.className, e.setAttribute("aria-hidden", "true"), e;
    }
  }, Lt = class extends ve {
    constructor(e = {}) {
      super(), this.name = "SwupProgressPlugin", this.defaults = { className: "swup-progress-bar", delay: 300, transition: 300, minValue: 0.1, initialValue: 0.25, finishAnimation: !0 }, this.options = void 0, this.progressBar = void 0, this.showProgressBarTimeout = void 0, this.hideProgressBarTimeout = void 0, this.options = Vn({}, this.defaults, e);
  ...
  var ys = () => {
    ...
    /<meta\s+http-equiv\s*=\s*["']refresh["']\s+content\s*=\s*["'][^"']*["']\s*\/?>/i.test(e.html) && (t.abort(), window.location.reload());
  };
  window.addEventListener("DOMContentLoaded", ys);
  !R && window.location.protocol !== "file:" && new St({
    animationSelector: !1,
    containers: ["#main"],
    ignoreVisit: (t) => {
      let e = t.split("#")[0];
      return e === window.location.pathname || e === window.location.pathname + ".html";
    },
