...
(function () {
    ...
    sidebarNav.on('click', '#modules_list', function () {
        fillSidebarWithNodes(sidebarNodes, "modules");
        resetSidebar();
        $('#modules_list').addClass('selected');
        $('#exceptions_list').removeClass('selected');
        $('#protocols_list').removeClass('selected');
    });

    sidebarNav.on('click', '#exceptions_list', function () {
        fillSidebarWithNodes(sidebarNodes, "exceptions");
        resetSidebar();
        $('#modules_list').removeClass('selected');
        $('#exceptions_list').addClass('selected');
        $('#protocols_list').removeClass('selected');
    });

    sidebarNav.on('click', '#protocols_list', function () {
        fillSidebarWithNodes(sidebarNodes, "protocols");
        resetSidebar();
        $('#modules_list').removeClass('selected');
        $('#exceptions_list').removeClass('selected');
        $('#protocols_list').addClass('selected');
    });
