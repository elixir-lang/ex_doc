defmodule ExDoc.Formatter.HTML.Templates do
  ...
  """
  def module_entry_page(module_node, node, nodes_map, config) do
    module_entry_template(config, module_node, node, nodes_map)
  end
  ...
  templates = [
    ...
    module_entry_template: [:config, :module, :node, :nodes_map],
