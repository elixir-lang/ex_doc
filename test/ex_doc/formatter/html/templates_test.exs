defmodule ExDoc.Formatter.HTML.TemplatesTest do
  ...
  test "enables nav link when module type have at least one element" do
    ...
    assert content =~ ~r{<li><a id="modules_list" href="#full-list">Modules</a></li>}
    refute content =~ ~r{<li><a id="exceptions_list" href="#full-list">Exceptions</a></li>}
    refute content =~ ~r{<li><a id="protocols_list" href="#full-list">Protocols</a></li>}
  end
  ...
  test "module_page contains links to summary sections when those exist" do
    ...
    refute content =~ ~r{types-details}
  end
